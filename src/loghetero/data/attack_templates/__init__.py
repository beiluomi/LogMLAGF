...
Five hand-coded templates covering the five TTPs selected for the Checkpoint 14.5
anomaly detection probe experiment (RFC-14.5-10: no network fetch, no LLM API).

Templates (RFC-14.5-1 accepted sequences, RFC-14.5-10 hand-coded):
