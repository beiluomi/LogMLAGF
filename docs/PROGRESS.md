...
- **当前 Phase**：Phase 5（RAPA 攻击模板正式实施，**创新点 2 核心阶段**）— **进行中（Checkpoint 15 RFC 完成 + 等 implementer 给实施 plan + user 裁定 plan 后正式开工 15 TTP 模板实施）**。Phase 4 已闭环 v0.4-fusion tag。
...
- **Checkpoint 15 RFC 决议（2026-05-08，user 拍板）**：15 TTP 候选全部接受（含 user 7 hint + implementer 8 选）+ 7 处 RFC question 全部接受 implementer 推荐附 4 处 tightening。15 TTP = T1566.001 / T1190 / T1078 / T1068 / T1055 / T1543.003 / T1053.005 / T1027 / T1070.004 / T1057 / T1083 / T1021.001 / T1560.001 / T1486 / T1490。Tactic 覆盖 10 distinct（≥8 hard requirement 满足）。预估 5.9 天工时（5d 上限可吸收到 Phase 5 整体 11-17d 内）。Schema workaround 3 处（T1055 svchost dual-typing + T1068 priv grant + T1021.001 RDP 多主机）已落 known_issues.md::Phase 5 待办::"Checkpoint 17 schema workaround inventory tracking" 作为 Checkpoint 17 upgrade plan anchor。
